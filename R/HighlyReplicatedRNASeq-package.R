...
#' HighlyReplicatedRNASeq: Collection of Bulk RNA-Seq Experiments With Many Replicates
#'
...
#'
#'
#' At the moment, this package contains only one dataset, but more
#' datasets can be added in the future.
#'
#' @docType package
